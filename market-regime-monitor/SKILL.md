...
Assess the market regime using two axes: liquidity conditions and sentiment/positioning crowding. Match the user's language, state dates for all data, cite sources, and frame output as research guidance rather than personalized investment advice.

Read `references/data-sources.md` for source priority, freshness TTL, regional proxies, and fallback rules.
...
4. Map the two axes into the risk regime matrix.
5. Explain asset impact for the user's scope: US equities, HK equities, A-shares, growth/tech, defensives, rates, USD, or crypto.
6. Provide monitoring triggers for the next 1-4 weeks.
...
## Risk Regime Score
[Liquidity axis] x [sentiment axis] => [regime].
