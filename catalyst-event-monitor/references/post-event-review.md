...
Use this file after an event happens. Judge the result against the pre-event expectation and thesis variables, not against the headline alone.
...
| Thesis broken | Event breaks a kill condition or key assumption | Evidence contradicts the core thesis variable |
| Crowded unwind | Thesis is not clearly broken, but positioning, valuation, or leverage forces de-risking | Price reaction mainly reflects crowding or expectation reset |
| Inconclusive | Data is missing, stale, or ambiguous | Need follow-up disclosure or next event |

## Post-Event Output

Include:

- What happened, with date and source.
- What was expected before the event.
- What surprised, if anything.
- Which thesis variable changed.
- Whether the valuation anchor should change.
- Whether the price reaction was fundamental, expectation reset, squeeze, sell-the-news, or crowded unwind.
- What to watch next and by when.
...
- Failing to distinguish delayed, impaired, broken, and crowded-unwind outcomes.
